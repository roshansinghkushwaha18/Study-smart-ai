...
**3. Business example**
A shop selling ${expression} units has ${result} units in total. A useful metric for a real stock decision would be inventory turnover.
...
const isLocalOrigin = (origin) => {
  ...
  return /^(https?:\/\/)(localhost|127\.0\.0\.1)(:\d+)?$/i.test(origin) ||
    origin === 'https://roshansinghkushwaha18.github.io';
};
